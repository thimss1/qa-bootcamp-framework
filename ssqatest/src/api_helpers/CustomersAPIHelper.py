...
class CustomersAPIHelper:
    ...
    def call_update_customer(self, cust_id, payload=None, expected_status_code=200):

        return self.woo_api_utility.put(f'customers/{cust_id}', params=payload, expected_status_code=expected_status_code)
