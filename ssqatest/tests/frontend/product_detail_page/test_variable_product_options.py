...
class TestVariableProductOptionValues:
    ...
    @pytest.mark.tcid97
    @pytest.mark.ecomfe141
    def test_variable_product_number_of_options(self, go_to_pdp_setup):
        """
        Test to verify the number of color and logo options available for a variable product.
         Args:
    ...
    @pytest.mark.tcid98
    @pytest.mark.ecomfe142
    def test_variable_product_values_of_color_options(self, go_to_pdp_setup):
        """
        Test to verify the values and text of the color options available for a variable product.
         Args:
            go_to_pdp_setup: A setup object.
        """
    ...
    @pytest.mark.tcid99
    @pytest.mark.ecomfe143
    def test_variable_product_values_of_logo_options(self, go_to_pdp_setup):
        """
        Test to verify the values and text of the logo options available for a variable product.
         Args:
            go_to_pdp_setup: A setup object.
        """
    ...
    @pytest.mark.tcid101
    @pytest.mark.ecomfe145
    def test_variable_product_clear_selection_btn_when_only_logo_is_selected(self, go_to_pdp_setup):
        """
        Test to verify the behavior of the clear selection button when only a logo option is selected.
        Args:
            go_to_pdp_setup: A setup object
        """
    ...
    @pytest.mark.tcid102
    @pytest.mark.ecomfe146
    def test_variable_product_clear_selection_btn_when_both_color_and_logo_are_selected(self, go_to_pdp_setup):
        """
        Test to verify the behavior of the clear selection button when both a color and logo option are selected.
         Args:
            go_to_pdp_setup: A setup object.
        """
