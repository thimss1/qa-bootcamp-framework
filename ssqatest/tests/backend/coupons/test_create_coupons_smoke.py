...
@pytest.mark.parametrize("discount_type",
                         [
                             ...
                             pytest.param('percent', marks=[pytest.mark.tcid37, pytest.mark.smoke,pytest.mark.ecombe74]),
                             pytest.param('fixed_product', marks=[pytest.mark.tcid38,pytest.mark.ecombe76]),
                             pytest.param('fixed_cart', marks=[pytest.mark.tcid39,pytest.mark.ecombe75]),
                         ])
